...
const systemPrompt = `You are a UI/UX designer knows HTML/CSS so much.
...
const schema = z.object({
  html: z.string().describe('HTML and CSS'),
  explanation: z.string().describe('The explanation of your design'),
});

const google = createGoogleGenerativeAI({ apiKey });

export const generateDesign = async (message: string) => {
  ...
  await getFigmaData(object.html);
};
